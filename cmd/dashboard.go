// Package cmd implements the cobra CLI commands for the chaos binary.
package cmd
...
var dashboardCmd = &cobra.Command{
	...
	RunE: func(_ *cobra.Command, _ []string) error {
		...
		fmt.Println("In the meantime, use 'chaos history' and 'chaos status' to review experiments.")
		fmt.Println("")
